...
// Version: 
// Last-Updated: Tue Aug 23 13:48:32 2011 (+0530)
//           By: Subhasis Ray
//     Update #: 65
// URL: 
// Keywords: 
...
#ifndef NDEBUG        
        cout << "STPNMDAChan::innerProcessFunc[" << e.id().path() << "]:: F[" << ii << "] = " << F_[ii] << ", D1[" << ii << "] = " << D1_[ii] << ", D2[" << ii << "] = " << D2_[ii] << endl;
#endif
    }
...
#ifndef NDEBUG
    cout << "STPNMDAChan::innerProcessFunc[" << e.id().path() << "]::Gk = " << Gk_ << ", Ek = " << Ek_ << ", Ik = " << Ik_ << ", unblocked = " << unblocked_ << endl;
#endif
}
...
#ifndef NDEBUG
        cout << "STPNMDAChan::innerSynapseFunc[" << conn->source().id().path() << "]: sending out event at time: " << time << ", F[" << index << "] = " << F_[index] << ", D1[" << index << "] = " << D1_[index] << ", D2[" << index << "] = " << D2_[index] << endl;
#endif
