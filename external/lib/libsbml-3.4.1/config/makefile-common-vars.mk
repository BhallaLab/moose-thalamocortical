...
## Created     : 2004-06-11
## Revision    : $Id: makefile-common-vars.mk.in 12964 2011-02-19 02:55:42Z mhucka $
## $HeadURL: http://sbml.svn.sourceforge.net/svnroot/sbml/trunk/libsbml/config/makefile-common-vars.mk.in $
##
## <!--------------------------------------------------------------------------
...
top_srcdir        = /data/subha/moose/external/lib/libsbml-3.4.1
top_builddir      = /data/subha/moose/external/lib/libsbml-3.4.1
...
LIBSBML_OPTIONS   =  USE_UNIVBINARY USE_PYTHON USE_PERL USE_JAVA USE_MATLAB USE_OCTAVE USE_RUBY USE_CSHARP USE_SWIG USE_EXPAT USE_XERCES USE_LIBCHECK USE_ZLIB
RUN_LDPATH        = /usr/lib64:/usr/lib:/usr/local/lib:/usr/local/lib/vtk-5.4
...
LIBSBML_VERSION   = 4.3.1
LIBSBML_VERSION_NUMERIC = 40301
