#!/bin/sh
# $Id: chk_swig_version.sh.in 12786 2011-02-08 19:05:42Z luciansmith $
# $URL: http://sbml.svn.sourceforge.net/svnroot/sbml/trunk/libsbml/config/chk_swig_version.sh.in $
# -----------------------------------------------------------------------------
