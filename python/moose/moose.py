...
class Calculator(Neutral):
    ...
    def __init__(self, *args): 
        """
        __init__(self, string className, string objectName, Id parentId) -> Calculator
        __init__(self, string className, string path) -> Calculator
        __init__(self, string className, string objectName, PyMooseBase parent) -> Calculator
        __init__(self, Id id) -> Calculator
        __init__(self, string path) -> Calculator
        __init__(self, string name, Id parentId) -> Calculator
        __init__(self, string name, PyMooseBase parent) -> Calculator
        __init__(self, Calculator src, string name, PyMooseBase parent) -> Calculator
        __init__(self, Calculator src, string name, Id parent) -> Calculator
        __init__(self, Calculator src, string path) -> Calculator
        __init__(self, Id src, string name, Id parent) -> Calculator
        __init__(self, Id src, string path) -> Calculator
        """
