...
CaConc::CaConc(std::string className, std::string objectName, Id parentId):Neutral(className, objectName, parentId){}
CaConc::CaConc(std::string className, std::string path):Neutral(className, path){}
CaConc::CaConc(std::string className, std::string objectName, PyMooseBase& parent):Neutral(className, objectName, parent){}
