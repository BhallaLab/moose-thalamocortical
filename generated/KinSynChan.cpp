...
KinSynChan::KinSynChan(std::string className, std::string objectName, Id parentId):SynChan(className, objectName, parentId){}
KinSynChan::KinSynChan(std::string className, std::string path):SynChan(className, path){}
KinSynChan::KinSynChan(std::string className, std::string objectName, PyMooseBase& parent):SynChan(className, objectName, parent){}
