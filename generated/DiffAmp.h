...
namespace pymoose{
    ...
    class DiffAmp : public Neutral
    {
      public:
        ...
        DiffAmp(std::string className, std::string objectName, Id parentId);
        DiffAmp(std::string className, std::string path);
        DiffAmp(std::string className, std::string objectName, PyMooseBase& parent);
        DiffAmp(Id id);
