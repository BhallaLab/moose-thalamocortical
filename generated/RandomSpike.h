...
namespace pymoose{
    ...
    class RandomSpike : public Neutral
    {
      public:
        ...
        RandomSpike(std::string className, std::string objectName, Id parentId);
        RandomSpike(std::string className, std::string path);
        RandomSpike(std::string className, std::string objectName, PyMooseBase& parent);
        RandomSpike(Id id);
