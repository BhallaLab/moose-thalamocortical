...
NMDAChan::NMDAChan(std::string className, std::string objectName, Id parentId):SynChan(className, objectName, parentId){}
NMDAChan::NMDAChan(std::string className, std::string path):SynChan(className, path){}
NMDAChan::NMDAChan(std::string className, std::string objectName, PyMooseBase& parent):SynChan(className, objectName, parent){}
