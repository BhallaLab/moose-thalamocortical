...
Surface::Surface(std::string className, std::string objectName, Id parentId):Neutral(className, objectName, parentId){}
Surface::Surface(std::string className, std::string path):Neutral(className, path){}
Surface::Surface(std::string className, std::string objectName, PyMooseBase& parent):Neutral(className, objectName, parent){}
