...
IntFire::IntFire(std::string className, std::string objectName, Id parentId):Neutral(className, objectName, parentId){}
IntFire::IntFire(std::string className, std::string path):Neutral(className, path){}
IntFire::IntFire(std::string className, std::string objectName, PyMooseBase& parent):Neutral(className, objectName, parent){}
