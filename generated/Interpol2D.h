...
namespace pymoose{
    ...
    class Interpol2D : public Interpol
    {
      public:
        ...
        Interpol2D(std::string className, std::string objectName, Id parentId);
        Interpol2D(std::string className, std::string path);
        Interpol2D(std::string className, std::string objectName, PyMooseBase& parent);
        Interpol2D(Id id);
