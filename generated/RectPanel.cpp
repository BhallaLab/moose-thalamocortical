...
RectPanel::RectPanel(std::string className, std::string objectName, Id parentId):Panel(className, objectName, parentId){}
RectPanel::RectPanel(std::string className, std::string path):Panel(className, path){}
RectPanel::RectPanel(std::string className, std::string objectName, PyMooseBase& parent):Panel(className, objectName, parent){}
