...
IzhikevichNrn::IzhikevichNrn(std::string className, std::string objectName, Id parentId):Neutral(className, objectName, parentId){}
IzhikevichNrn::IzhikevichNrn(std::string className, std::string path):Neutral(className, path){}
IzhikevichNrn::IzhikevichNrn(std::string className, std::string objectName, PyMooseBase& parent):Neutral(className, objectName, parent){}
