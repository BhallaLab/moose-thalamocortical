...
Geometry::Geometry(std::string className, std::string objectName, Id parentId):Neutral(className, objectName, parentId){}
Geometry::Geometry(std::string className, std::string path):Neutral(className, path){}
Geometry::Geometry(std::string className, std::string objectName, PyMooseBase& parent):Neutral(className, objectName, parent){}
