...
Compartment::Compartment(std::string className, std::string objectName, Id parentId):Neutral(className, objectName, parentId){}
Compartment::Compartment(std::string className, std::string path):Neutral(className, path){}
Compartment::Compartment(std::string className, std::string objectName, PyMooseBase& parent):Neutral(className, objectName, parent){}
...
{
    double x0;
    get < double > (id_(), "x0",x0);
    return x0;
}
void Compartment::__set_x0( double x0 )
{
    set < double > (id_(), "x0", x0);
}
double Compartment::__get_y0() const
{
    double y0;
    get < double > (id_(), "y0",y0);
    return y0;
}
void Compartment::__set_y0( double y0 )
{
    set < double > (id_(), "y0", y0);
}
double Compartment::__get_z0() const
{
    double z0;
    get < double > (id_(), "z0",z0);
    return z0;
}
void Compartment::__set_z0( double z0 )
{
    set < double > (id_(), "z0", z0);
}
