...
SteadyState::SteadyState(std::string className, std::string objectName, Id parentId):Neutral(className, objectName, parentId){}
SteadyState::SteadyState(std::string className, std::string path):Neutral(className, path){}
SteadyState::SteadyState(std::string className, std::string objectName, PyMooseBase& parent):Neutral(className, objectName, parent){}
