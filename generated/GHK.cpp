...
GHK::GHK(std::string className, std::string objectName, Id parentId):Neutral(className, objectName, parentId){}
GHK::GHK(std::string className, std::string path):Neutral(className, path){}
GHK::GHK(std::string className, std::string objectName, PyMooseBase& parent):Neutral(className, objectName, parent){}
