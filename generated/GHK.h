...
namespace pymoose{
    ...
    class GHK : public Neutral
    {
      public:
        ...
        GHK(std::string className, std::string objectName, Id parentId);
        GHK(std::string className, std::string path);
        GHK(std::string className, std::string objectName, PyMooseBase& parent);
        GHK(Id id);
        GHK(std::string path);
