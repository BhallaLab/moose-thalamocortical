...
AscFile::AscFile(std::string className, std::string objectName, Id parentId):Neutral(className, objectName, parentId){}
AscFile::AscFile(std::string className, std::string path):Neutral(className, path){}
AscFile::AscFile(std::string className, std::string objectName, PyMooseBase& parent):Neutral(className, objectName, parent){}
