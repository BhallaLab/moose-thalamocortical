...
Leakage::Leakage(std::string className, std::string objectName, Id parentId):Neutral(className, objectName, parentId){}
Leakage::Leakage(std::string className, std::string path):Neutral(className, path){}
Leakage::Leakage(std::string className, std::string objectName, PyMooseBase& parent):Neutral(className, objectName, parent){}
