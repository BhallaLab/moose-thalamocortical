...
SymCompartment::SymCompartment(std::string className, std::string objectName, Id parentId):Compartment(className, objectName, parentId){}
SymCompartment::SymCompartment(std::string className, std::string path):Compartment(className, path){}
SymCompartment::SymCompartment(std::string className, std::string objectName, PyMooseBase& parent):Compartment(className, objectName, parent){}
