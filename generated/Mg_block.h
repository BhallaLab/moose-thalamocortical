...
namespace pymoose{
    ...
    class Mg_block : public Neutral
    {
      public:
        ...
        Mg_block(std::string className, std::string objectName, Id parentId);
        Mg_block(std::string className, std::string path);
        Mg_block(std::string className, std::string objectName, PyMooseBase& parent);
        Mg_block(Id id);
