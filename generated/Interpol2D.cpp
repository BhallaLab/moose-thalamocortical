...
Interpol2D::Interpol2D(std::string className, std::string objectName, Id parentId):Interpol(className, objectName, parentId){}
Interpol2D::Interpol2D(std::string className, std::string path):Interpol(className, path){}
Interpol2D::Interpol2D(std::string className, std::string objectName, PyMooseBase& parent):Interpol(className, objectName, parent){}
