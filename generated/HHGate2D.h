...
namespace pymoose{
    ...
    class HHGate2D : public HHGate
    {
      public:
        ...
        HHGate2D(std::string className, std::string objectName, Id parentId);
        HHGate2D(std::string className, std::string path);
        HHGate2D(std::string className, std::string objectName, PyMooseBase& parent);
        HHGate2D(Id id);
