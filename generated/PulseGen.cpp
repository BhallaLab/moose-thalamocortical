...
PulseGen::PulseGen(std::string className, std::string objectName, Id parentId):Neutral(className, objectName, parentId){}
PulseGen::PulseGen(std::string className, std::string path):Neutral(className, path){}
PulseGen::PulseGen(std::string className, std::string objectName, PyMooseBase& parent):Neutral(className, objectName, parent){}
...
int PulseGen::__get_count() const
{
    int count;
    get < int > (id_(), "count",count);
    return count;
}
void PulseGen::__set_count( int count )
{
