...
namespace pymoose{
    ...
    class Compartment : public Neutral
    {
      public:
        ...
        Compartment(std::string className, std::string objectName, Id parentId);
        Compartment(std::string className, std::string path);
        Compartment(std::string className, std::string objectName, PyMooseBase& parent);
        Compartment(Id id);
        ...
        const std::string& getType();
            ...
            void __set_x0(double x0);
            double __get_y0() const;
            void __set_y0(double y0);
            double __get_z0() const;
            void __set_z0(double z0);
