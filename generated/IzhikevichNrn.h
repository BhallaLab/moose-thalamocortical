...
namespace pymoose{
    ...
    class IzhikevichNrn : public Neutral
    {
      public:
        ...
        IzhikevichNrn(std::string className, std::string objectName, Id parentId);
        IzhikevichNrn(std::string className, std::string path);
        IzhikevichNrn(std::string className, std::string objectName, PyMooseBase& parent);
        IzhikevichNrn(Id id);
