...
namespace pymoose{
    ...
    class SteadyState : public Neutral
    {
      public:
        ...
        SteadyState(std::string className, std::string objectName, Id parentId);
        SteadyState(std::string className, std::string path);
        SteadyState(std::string className, std::string objectName, PyMooseBase& parent);
        SteadyState(Id id);
