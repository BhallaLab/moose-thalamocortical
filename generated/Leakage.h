...
namespace pymoose{
    ...
    class Leakage : public Neutral
    {
      public:
        ...
        Leakage(std::string className, std::string objectName, Id parentId);
        Leakage(std::string className, std::string path);
        Leakage(std::string className, std::string objectName, PyMooseBase& parent);
        Leakage(Id id);
