...
namespace pymoose{
    ...
    class DifShell : public Neutral
    {
      public:
        ...
        DifShell(std::string className, std::string objectName, Id parentId);
        DifShell(std::string className, std::string path);
        DifShell(std::string className, std::string objectName, PyMooseBase& parent);
        DifShell(Id id);
