...
CylPanel::CylPanel(std::string className, std::string objectName, Id parentId):Panel(className, objectName, parentId){}
CylPanel::CylPanel(std::string className, std::string path):Panel(className, path){}
CylPanel::CylPanel(std::string className, std::string objectName, PyMooseBase& parent):Panel(className, objectName, parent){}
