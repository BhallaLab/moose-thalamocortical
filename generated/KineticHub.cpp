...
KineticHub::KineticHub(std::string className, std::string objectName, Id parentId):Neutral(className, objectName, parentId){}
KineticHub::KineticHub(std::string className, std::string path):Neutral(className, path){}
KineticHub::KineticHub(std::string className, std::string objectName, PyMooseBase& parent):Neutral(className, objectName, parent){}
