...
GammaRng::GammaRng(std::string className, std::string objectName, Id parentId):RandGenerator(className, objectName, parentId){}
GammaRng::GammaRng(std::string className, std::string path):RandGenerator(className, path){}
GammaRng::GammaRng(std::string className, std::string objectName, PyMooseBase& parent):RandGenerator(className, objectName, parent){}
...
GammaRng::GammaRng(const Id& src, std::string name, Id& parent):RandGenerator(src, name, parent){}
