...
namespace pymoose{
    ...
    class KineticManager : public KinCompt
    {
      public:
        ...
        KineticManager(std::string className, std::string objectName, Id parentId);
        KineticManager(std::string className, std::string path);
        KineticManager(std::string className, std::string objectName, PyMooseBase& parent);
        ...
        const std::string& getType();
            bool __get_auto() const;
            void __set_auto(bool auto);
