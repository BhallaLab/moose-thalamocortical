...
Adaptor::Adaptor(std::string className, std::string objectName, Id parentId):Neutral(className, objectName, parentId){}
Adaptor::Adaptor(std::string className, std::string path):Neutral(className, path){}
Adaptor::Adaptor(std::string className, std::string objectName, PyMooseBase& parent):Neutral(className, objectName, parent){}
