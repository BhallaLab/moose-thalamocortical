...
NormalRng::NormalRng(std::string className, std::string objectName, Id parentId):RandGenerator(className, objectName, parentId){}
NormalRng::NormalRng(std::string className, std::string path):RandGenerator(className, path){}
NormalRng::NormalRng(std::string className, std::string objectName, PyMooseBase& parent):RandGenerator(className, objectName, parent){}
...
NormalRng::NormalRng(const Id& src, std::string name, Id& parent):RandGenerator(src, name, parent){}
NormalRng::NormalRng(const Id& src, std::string path):RandGenerator(src, path){}
NormalRng::~NormalRng(){}
