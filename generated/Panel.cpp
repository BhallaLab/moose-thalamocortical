...
Panel::Panel(std::string className, std::string objectName, Id parentId):Neutral(className, objectName, parentId){}
Panel::Panel(std::string className, std::string path):Neutral(className, path){}
Panel::Panel(std::string className, std::string objectName, PyMooseBase& parent):Neutral(className, objectName, parent){}
