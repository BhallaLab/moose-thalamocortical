...
namespace pymoose{
    ...
    class PIDController : public Neutral
    {
      public:
        ...
        PIDController(std::string className, std::string objectName, Id parentId);
        PIDController(std::string className, std::string path);
        PIDController(std::string className, std::string objectName, PyMooseBase& parent);
        PIDController(Id id);
