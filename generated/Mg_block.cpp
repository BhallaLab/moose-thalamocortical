...
Mg_block::Mg_block(std::string className, std::string objectName, Id parentId):Neutral(className, objectName, parentId){}
Mg_block::Mg_block(std::string className, std::string path):Neutral(className, path){}
Mg_block::Mg_block(std::string className, std::string objectName, PyMooseBase& parent):Neutral(className, objectName, parent){}
