...
RC::RC(std::string className, std::string objectName, Id parentId):Neutral(className, objectName, parentId){}
RC::RC(std::string className, std::string path):Neutral(className, path){}
RC::RC(std::string className, std::string objectName, PyMooseBase& parent):Neutral(className, objectName, parent){}
