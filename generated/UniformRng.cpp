...
UniformRng::UniformRng(std::string className, std::string objectName, Id parentId):RandGenerator(className, objectName, parentId){}
UniformRng::UniformRng(std::string className, std::string path):RandGenerator(className, path){}
UniformRng::UniformRng(std::string className, std::string objectName, PyMooseBase& parent):RandGenerator(className, objectName, parent){}
...
UniformRng::UniformRng(const Id& src, std::string name, Id& parent):RandGenerator(src, name, parent){}
