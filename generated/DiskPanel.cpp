...
DiskPanel::DiskPanel(std::string className, std::string objectName, Id parentId):Panel(className, objectName, parentId){}
DiskPanel::DiskPanel(std::string className, std::string path):Panel(className, path){}
DiskPanel::DiskPanel(std::string className, std::string objectName, PyMooseBase& parent):Panel(className, objectName, parent){}
