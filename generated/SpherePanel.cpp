...
SpherePanel::SpherePanel(std::string className, std::string objectName, Id parentId):Panel(className, objectName, parentId){}
SpherePanel::SpherePanel(std::string className, std::string path):Panel(className, path){}
SpherePanel::SpherePanel(std::string className, std::string objectName, PyMooseBase& parent):Panel(className, objectName, parent){}
