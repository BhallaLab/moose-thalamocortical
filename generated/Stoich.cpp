...
const string&  Stoich::__get_path() const
{
...
none Stoich::__get_pathVec() const
{
    none pathVec;
    get < none > (id_(), "pathVec",pathVec);
    return pathVec;
}
void Stoich::__set_pathVec( none pathVec )
{
    set < none > (id_(), "pathVec", pathVec);
}
