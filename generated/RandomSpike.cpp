...
RandomSpike::RandomSpike(std::string className, std::string objectName, Id parentId):Neutral(className, objectName, parentId){}
RandomSpike::RandomSpike(std::string className, std::string path):Neutral(className, path){}
RandomSpike::RandomSpike(std::string className, std::string objectName, PyMooseBase& parent):Neutral(className, objectName, parent){}
