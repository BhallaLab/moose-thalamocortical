...
DifShell::DifShell(std::string className, std::string objectName, Id parentId):Neutral(className, objectName, parentId){}
DifShell::DifShell(std::string className, std::string path):Neutral(className, path){}
DifShell::DifShell(std::string className, std::string objectName, PyMooseBase& parent):Neutral(className, objectName, parent){}
