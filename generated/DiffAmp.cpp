...
DiffAmp::DiffAmp(std::string className, std::string objectName, Id parentId):Neutral(className, objectName, parentId){}
DiffAmp::DiffAmp(std::string className, std::string path):Neutral(className, path){}
DiffAmp::DiffAmp(std::string className, std::string objectName, PyMooseBase& parent):Neutral(className, objectName, parent){}
